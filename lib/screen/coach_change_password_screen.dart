...
class CoachChangePasswordScreen extends StatefulWidget {
  @override
  _CoachChangePasswordScreenState createState() =>
      _CoachChangePasswordScreenState();
}

class _CoachChangePasswordScreenState extends State<CoachChangePasswordScreen> {
